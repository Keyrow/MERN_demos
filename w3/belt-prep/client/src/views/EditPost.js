...
const EditPost = (props) => {
  ...
  const fetchData = () => {
    axios
      ...
      .then((res) => {
        const postFromDb = res.data;

        setTitle(postFromDb.title);
        setDescription(postFromDb.description);
        setImgUrl(postFromDb.imgUrl);
        setPrimaryCategory(postFromDb.primaryCategory);
        setSecondaryCategory(postFromDb.secondaryCategory);
      })
      .catch((err) => {
